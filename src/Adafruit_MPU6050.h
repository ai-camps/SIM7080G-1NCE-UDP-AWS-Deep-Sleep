 ...
 */
typedef enum {
  MPU6050_ACC_RANGE_2G = 0b00,  ///< +/- 2g (default value)
  MPU6050_ACC_RANGE_4G = 0b01,  ///< +/- 4g
  MPU6050_ACC_RANGE_8G = 0b10,  ///< +/- 8g
  MPU6050_ACC_RANGE_16G = 0b11, ///< +/- 16g
 ...
 */
typedef enum {
  MPU6050_GYR_RANGE_250_DEG,  ///< +/- 250 deg/s (default value)
  MPU6050_GYR_RANGE_500_DEG,  ///< +/- 500 deg/s
  MPU6050_GYR_RANGE_1000_DEG, ///< +/- 1000 deg/s
  MPU6050_GYR_RANGE_2000_DEG, ///< +/- 2000 deg/s
